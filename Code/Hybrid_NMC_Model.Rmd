...
inbred_train_data = read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/Moisture_Uptake_Master_Dataset_Cook_Macro_Spectra.csv') %>%
  select(1,2,26:167)

inbred_val_data = read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/ML_Master_Validation_Dataset.csv') %>%
...
inbred_comp = inbred_train_data %>%
  select(Sample_ID, Moisture_Uptake) %>% 
  left_join(read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/Moisture_Uptake_Master_Dataset_Cook_Macro_Spectra.csv') %>%
    select(1,2,20:25)) %>%
