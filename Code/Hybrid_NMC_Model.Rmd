...
inbred_train_data = read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/Burns_et_al_2021_Inbred_Training_Set.csv') %>%
  select(1,2,26:167)

inbred_val_data = read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/Burns_et_al_2021_Inbred_Validation_Set.csv') %>%
  rename(Sample_ID = SampleID)

hybrid_scans = read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/Scans/Hybrid_Maize_NIR_Spectra_Coded.csv')

hybrid_data = read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/Hybrid_Training_Data_305_Coded.csv')

hybrid_val_data = read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/Final_Validation_Samples_Coded.csv')

sum(hybrid_val_data$Genotype %in% hybrid_data$Genotype)

hybrid_genos_xref = read_csv('/Users/michael/Desktop/Grad_School/Research/Hybrid_NMC/Data/XRefs/Hybrid_Genotypes_XRef_Coded.csv') %>%
  unique()
...
ggsave('/Users/michael/Desktop/Grad_School/Research/Hybrid_NMC/Outputs/Inbred_Hybrid_22_23_PCA_Spectral_Space.png', inbred_hybrid_22_23_pca_plot, width = 3.75, height = 2.2, dpi = 300)
...
ggsave('/Users/michael/Desktop/Grad_School/Research/Hybrid_NMC/Outputs/All_Inbred_Hybrid_PCA_Spectral_Space.png', all_inbred_hybrid_pca_plot, width = 3.75, height = 4.4, dpi = 300)
```
...
inbred_comp = inbred_train_data %>%
  select(Sample_ID, Moisture_Uptake) %>% 
  left_join(read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/Burns_et_al_2021_Inbred_Training_Set.csv') %>%
    select(1,2,20:25)) %>%
...
ggsave('/Users/michael/Desktop/Grad_School/Research/Hybrid_NMC/Outputs/Training_Remaining_PCA_Spectral_Space.png', training_spectra_pca, width = 3.75, height = 3.25, dpi = 300)
```
...
```{r compare training and all hybrid data, message = F, warning = F}
hybrid_comp_all = read_csv('/Users/michael/Desktop/Grad_School/Research/Hybrid_NMC/Data/Scans/Hybrid_Maize_Composition_Predictions_Coded.csv') %>%
...
ggsave('/Users/michael/Desktop/Grad_School/Research/Hybrid_NMC/Outputs/Composition_Distributions_All.png', comp_plot_all, width = 3.75, height = 6, dpi = 300)
```
...
for(exp in unique(comm_met_comps$Experiment)){
  ...
  if(exp == "Agronomic Trial"){
    ...
    comm_met_comps_sub = comm_met_comps %>%
      filter(Experiment == exp) %>% 
      left_join(read_csv('~/Desktop/Grad_School/Research/Hybrid_NMC/Data/XRefs/PA_Hybrids_XRef_Coded.csv') %>%
...
ggsave('/Users/michael/Desktop/Grad_School/Research/Hybrid_NMC/Outputs/app_speed_plot.png',
